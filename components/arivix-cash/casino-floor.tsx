...
export function CasinoFloor({ children }: { children: ReactNode }) {
  return (
    <section
      className="arivix-cash-floor-shell relative overflow-hidden rounded-2xl border border-amber-500/20 bg-gradient-to-b from-emerald-950/25 via-zinc-950/95 to-black shadow-[0_0_0_1px_rgba(0,0,0,0.55),0_0_80px_-28px_rgba(234,179,8,0.18),inset_0_1px_0_rgba(255,255,255,0.05)]"
      aria-labelledby="arivix-cash-tables-heading"
    >
      <div
