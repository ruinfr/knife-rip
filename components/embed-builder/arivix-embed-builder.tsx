...
import { serializeArivixEmbedScript, type ArivixParsedEmbed } from "@/lib/embed-script";
...
export function ArivixEmbedBuilder() {
  ...
  const generated = useMemo(
    () =>
      serializeArivixEmbedScript(messageContent, {
        title,
        description,
        url,
        color,
