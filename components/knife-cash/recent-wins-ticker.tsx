  ...
  return (
    ...
    >
      ...
      {err ? (
        ...
        <div
          className="knife-cash-wins-track px-4"
          style={
            {
              "--knife-cash-marquee-duration": `${durationSec}s`,
            } as CSSProperties & { "--knife-cash-marquee-duration"?: string }
          }
        >
          <div className="knife-cash-wins-marquee flex gap-2 pr-2">
            {loopWins.map((w, i) => (
